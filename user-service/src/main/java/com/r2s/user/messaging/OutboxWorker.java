...
public class OutboxWorker {
    ...
    public void process() {
        ...
        List<Outbox> list = outboxRepository
        ...
        for (Outbox o : list) {
            ...
            try {
                log.warn("Outbox retry {}", o.getRetryCount());

                UserRegisteredEvent event =
                        objectMapper.readValue(o.getPayload(), UserRegisteredEvent.class);
                ...
                log.error("Outbox {} failed", o.getId(), e);
                outboxRepository.increaseRetry(o.getId());
            }
        }
    }
    @PostConstruct
